...
import com.amazon.audiblecambridgehsfindbookalexaskill.findbook.handlers.*;
    ...
    private static Skill getSkill() {
        return Skills.standard()
                .addRequestHandlers(
                        ...
                        new FetchReadingListsIntentHandler(),
                        new CreateMultipleListsIntentHandler(),
                        new DeleteListByNameIntentHandler(),
                        new GetFromReadingListIntentHandler(),
                        new CreateReadingListIntentHandler(),
